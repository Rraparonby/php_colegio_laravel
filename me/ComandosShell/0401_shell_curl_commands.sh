    ...
    do  
        ...
        case $opcion in
            0)  salir; break; 
				;;								
			1)  
                curl -X POST -H 'Content-Type: application/json' 'http://localhost:3000/laravel_colegio_rels/api/colegio_relaciones/estructura/materia_api' -d '{
					"pagination":{
									"skip": 0,
									"limit": 10
								}
				...
				# 3000 -> 81, 
				# /materia_api/ -> /materia_api

				# api/ 
				# laravel_colegio_rels/api/ 
