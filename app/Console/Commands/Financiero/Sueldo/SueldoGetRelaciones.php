...
class SueldoGetRelaciones extends Command {
	
    /* The name and signature of the console command.
     * @var string */
    protected $signature = 'sueldo:get_relaciones {limit} {skip}';
    ...
    public function handle() {
		...
		foreach($this->sueldos as $sueldo) {
			/*----- FKs -----*/
			
			$docente = $sueldo->docente;	
			
			/*----- Relaciones -----*/
			
		}
		
		$this->info($this->sueldos);
