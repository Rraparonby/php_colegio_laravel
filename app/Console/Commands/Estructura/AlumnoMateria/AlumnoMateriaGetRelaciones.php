...
class AlumnoMateriaGetRelaciones extends Command {
	
    /* The name and signature of the console command.
     * @var string */
    protected $signature = 'alumno_materia:get_relaciones {limit} {skip}';
    ...
    public function handle() {
		...
		foreach($this->alumno_materias as $alumno_materia) {
			/*----- FKs -----*/
			
			$alumno = $alumno_materia->alumno;	
			$materia = $alumno_materia->materia;	
			
			/*----- Relaciones -----*/
			
		}
		
		$this->info($this->alumno_materias);
