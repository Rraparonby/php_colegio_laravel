...
class AlumnoGetRelaciones extends Command {
	
    /* The name and signature of the console command.
     * @var string */
    protected $signature = 'alumno:get_relaciones {limit} {skip}';
    ...
    public function handle() {
		...
		foreach($this->alumnos as $alumno) {
			...
			$alumno_materias = $alumno->alumno_materias;
			$materias = $alumno->materias;
			$pensions = $alumno->pensions;
			$notas = $alumno->notas;

		}
		
		$this->info($this->alumnos);
